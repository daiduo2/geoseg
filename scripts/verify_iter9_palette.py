#!/usr/bin/env python3
"""Verify iteration 9 palette adjustments and revert entries that worsened color fidelity."""
...
def main():
    ...
    before_dir = ref_root / "workflow_color_correction" / "iter_8_verified"
    after_dir = ref_root / "workflow_color_correction" / "iter_9"
    out_dir = ref_root / "workflow_color_correction" / "iter_9_verified"
    ...
    iter9_changes = state["adjustments"][8]["changes"]
    ...
    for profile in profiles:
        ...
        after_mask = load_image(after_dir / profile / "mask_corrected.jpg")
        after_mask = after_mask[:h, :w]
        ...
        for change in iter9_changes:
            ...
            if bbox is not None:
                ...
                titles = ["Original", "Iter 8 verified", "Iter 9 verified"]
                images = [
    ...
    fig.suptitle(
        "Iteration 9 verification: iter 8 verified vs. iter 9 verified (worse entries reverted)",
        fontsize=12,
    )
