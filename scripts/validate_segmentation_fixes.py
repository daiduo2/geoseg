...
# Key targets to validate (fig_key -> expected issues)
KEY_TARGETS = [
    "fwi_deeponet_2024/fwi_deeponet_2024_page8_img0",
    "tomography_review_2024/tomography_review_2024_page5_img1",
    "tomography_review_2024/tomography_review_2024_page8_img3",
    "ml_velocity_2024/ml_velocity_2024_page22_img2",
]
...
def main() -> None:
    ...
    for fig_key in KEY_TARGETS:
        target = best.get(fig_key)
        if not target:
            print(f"SKIP {fig_key}: not in results")
            continue
