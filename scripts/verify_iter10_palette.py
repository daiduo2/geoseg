#!/usr/bin/env python3
"""Verify iteration 10 palette adjustments and revert entries that worsened color fidelity."""
...
def main():
    ...
    out_dir = ref_root / "workflow_color_correction" / "iter_10_verified"
    ...
    # Visual review decisions: revert any (profile, label) that worsened the region.
    revert_set = {("fig6_profile_05", 12)}
    ...
    fig.suptitle(
        "Iteration 10 verification: iter 9 verified vs. iter 10 verified (worse entries reverted)",
        fontsize=12,
    )
