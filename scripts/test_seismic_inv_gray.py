#!/usr/bin/env python3
"""Test seismic_inv_2024 page9_img1 (grayscale velocity model)."""
...
def main() -> None:
    ...
    h, w = img_rgb.shape[:2]
    # This is a tall image (4459x1100), likely multi-panel
    # Let's take top portion or resize
    max_dim = 2000
    if max(h, w) > max_dim:
    ...
    out_name = "seismic_inv_2024_seismic_inv_2024_page9_img1_panel0_resized.png"
