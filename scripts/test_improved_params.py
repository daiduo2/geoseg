#!/usr/bin/env python3
"""Test improved vertical_scan_reps params on key images."""
...
AUDIT_DIR = Path("runs/new_papers_vlm/quality_review_audit_v3")
...
def process_and_review(img_path: Path, desc: str, n_hint: int = 5, target_panel_id: int | None = None) -> dict:
    ...
    for pb in target_panels:
        ...
        out_name = f"{desc.replace(' ', '_').replace('/', '_')}_panel{panel_id}_{n_found}layers_v3.png"
...
def main() -> None:
    ...
    report_path = AUDIT_DIR / "v3_report.json"
