#!/usr/bin/env python3
"""Test top-scoring candidates from screening."""
...
AUDIT_DIR = Path("runs/new_papers_vlm/quality_review_audit_top")
...
def process_and_review(img_path: Path, desc: str, n_hint: int = 5, target_panel_id: int | None = None) -> list[dict]:
    print(f"\n{'='*60}")
    ...
    for pb in target_panels:
        ...
        out_name = f"{desc.replace(' ', '_').replace('/', '_')}_panel{panel_id}_{n_found}layers_top.png"
...
def main() -> None:
    ...
    test_cases = [
        # Paper 1: fwi_deeponet — single vivid panel
        ("papers_new/to_process/fwi_deeponet_2024/fwi_deeponet_2024_page1_img1.png", "fwi_deeponet page1_img1", 6, None),
        ("papers_new/to_process/fwi_deeponet_2024/fwi_deeponet_2024_page1_img2.png", "fwi_deeponet page1_img2", 5, None),

        # Paper 2: ml_velocity — high saturation single panel
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page12_img0.png", "ml_velocity page12_img0", 6, None),
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page12_img1.png", "ml_velocity page12_img1", 5, None),

        # Paper 3: uncertainty_fwi
        ("papers_new/to_process/uncertainty_fwi_2024/uncertainty_fwi_2024_page9_img2.png", "uncertainty_fwi page9_img2", 4, None),
        ("papers_new/to_process/uncertainty_fwi_2024/uncertainty_fwi_2024_page7_img3.png", "uncertainty_fwi page7_img3", 5, None),

        # Paper 4: seismic_inv — better candidates
        ("papers_new/to_process/seismic_inv_2024/seismic_inv_2024_page6_img2.png", "seismic_inv page6_img2", 3, None),
        ("papers_new/to_process/seismic_inv_2024/seismic_inv_2024_page8_img1.png", "seismic_inv page8_img1", 4, None),

        # Paper 5: tomography_review
        ("papers_new/to_process/tomography_review_2024/tomography_review_2024_page5_img2.png", "tomography_review page5_img2", 4, 2),

        # Alternative: wise_fwi
        ("papers_new/to_process/wise_fwi_2024/wise_fwi_2024_page7_img1.png", "wise_fwi page7_img1", 5, None),
    ]
    ...
    report_path = AUDIT_DIR / "top_report.json"
