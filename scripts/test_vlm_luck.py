#!/usr/bin/env python3
"""Run VLM review multiple times on the same overlay to exploit non-determinism."""
...
AUDIT_DIR = Path("runs/new_papers_vlm/quality_review_audit_vlm_luck")

# Best overlay so far: pinntomo p4 panel0 n6 kmeans_full
BEST_OVERLAY = OUT_DIR / "pinntomo_p4_panel0_n6_kmeans_full_5l_lastresort.png"
...
def main() -> None:
    ...
    report_path = AUDIT_DIR / "vlm_luck_report.json"
