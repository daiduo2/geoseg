#!/usr/bin/env python3
"""Test multiple candidate images to find the best 5-paper set."""
...
def main() -> None:
    ...
    test_cases = [
        # Paper 1: seismic_inv (already have 0.85)
        ("papers_new/to_process/seismic_inv_2024/seismic_inv_2024_page9_img1.png", "seismic_inv page9_img1", 5, 2),

        # Paper 2: fwi_deeponet (was 0.83)
        ("papers_new/to_process/fwi_deeponet_2024/fwi_deeponet_2024_page8_img0.png", "fwi_deeponet page8", 7, 0),

        # Paper 3: ml_velocity - try original + alternatives
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page22_img2.png", "ml_velocity page22_img2", 4, None),
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page22_img3.png", "ml_velocity page22_img3", 4, None),
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page21_img0.png", "ml_velocity page21_img0", 4, None),
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page14_img0.png", "ml_velocity page14_img0", 4, 0),

        # Paper 4: tomography_review - try original + alternatives
        ("papers_new/to_process/tomography_review_2024/tomography_review_2024_page5_img2.png", "tomography_review page5_img2", 4, 2),
        ("papers_new/to_process/tomography_review_2024/tomography_review_2024_page8_img3.png", "tomography_review page8_img3", 5, 2),
        ("papers_new/to_process/tomography_review_2024/tomography_review_2024_page7_img0.png", "tomography_review page7_img0", 4, None),

        # Paper 5: wise_fwi - try original + alternatives
        ("papers_new/to_process/wise_fwi_2024/wise_fwi_2024_page5_img2.png", "wise_fwi page5_img2", 5, None),
        ("papers_new/to_process/wise_fwi_2024/wise_fwi_2024_page7_img1.png", "wise_fwi page7_img1", 4, None),
    ]
    ...
    report_path = AUDIT_DIR / "v4_report.json"
