#!/usr/bin/env python3
"""Quick test of promising untested candidates."""
...
AUDIT_DIR = Path("runs/new_papers_vlm/quality_review_audit_quick")
...
def process_and_review(img_path: Path, desc: str, n_hint: int = 5, engine: str | None = None) -> list[dict]:
    print(f"\n{'='*60}")
    ...
    for pb in target_panels:
        ...
        out_name = f"{desc.replace(' ', '_').replace('/', '_')}_panel{panel_id}_{n_found}layers_quick.png"
...
def main() -> None:
    ...
    test_cases = [
        # fwi_deeponet page1_img3 (untested, score=34)
        ("papers_new/to_process/fwi_deeponet_2024/fwi_deeponet_2024_page1_img3.png", "fwi_deeponet page1_img3", 4),

        # deep_tomo_2024 candidates with higher saturation
        ("papers_new/to_process/deep_tomo_2024/deep_tomo_2024_page22_img10.png", "deep_tomo page22_img10", 3),
        ("papers_new/to_process/deep_tomo_2024/deep_tomo_2024_page9_img0.png", "deep_tomo page9_img0", 3),
        ("papers_new/to_process/deep_tomo_2024/deep_tomo_2024_page7_img0.png", "deep_tomo page7_img0", 7),

        # uncertainty_fwi - page5 has larger panels
        ("papers_new/to_process/uncertainty_fwi_2024/uncertainty_fwi_2024_page5_img4.png", "uncertainty page5_img4", 4),
        ("papers_new/to_process/uncertainty_fwi_2024/uncertainty_fwi_2024_page5_img8.png", "uncertainty page5_img8", 3),

        # ml_velocity - try img7/img8 with different sat
        ("papers_new/to_process/ml_velocity_2024/ml_velocity_2024_page12_img7.png", "ml_velocity page12_img7", 6),

        # wise_fwi page5_img1 (score=30)
        ("papers_new/to_process/wise_fwi_2024/wise_fwi_2024_page5_img1.png", "wise_fwi page5_img1", 6),

        # tomography_review page9_img0
        ("papers_new/to_process/tomography_review_2024/tomography_review_2024_page9_img0.png", "tomography_review page9_img0", 10),
    ]

    for img_path_str, desc, n_hint in test_cases:
        img_path = Path(img_path_str)
        if not img_path.exists():
            print(f"SKIP: {img_path} not found")
            continue
        results = process_and_review(img_path, desc, n_hint=n_hint)
        all_results.extend(results)

    report_path = AUDIT_DIR / "quick_report.json"
